...
def process_pages(pages_dict):
    for page_number, text in pages_dict.items():
        ...
        pic = slide.shapes.add_picture(r"E:\gitplay\ITS\OpenEduECNU-main\OpenEduECNU-main\class_assistant\pic\3.png", left, top, slide_width,
                                       slide_height)
...
def create_pptx(course_name, unit_name, course_num, course_time, course_sub, file):
    ...
    # 将图像添加为幻灯片上的形状，覆盖整个幻灯片
    pic = slide.shapes.add_picture(r"E:\gitplay\ITS\OpenEduECNU-main\OpenEduECNU-main\class_assistant\pic\2.png", left, top, slide_width, slide_height)
